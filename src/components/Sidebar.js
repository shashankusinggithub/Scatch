...
export default function Sidebar() {
  ...
  const motionList = [
    {
      func: "move fw",
      class:
        "flex flex-row flex-wrap bg-blue-800 text-white px-2 py-1 my-2 text-sm cursor-pointer",
  ...
  return (
    <div
      className="w-50 flex-none h-full  items-start overflow-y-auto flex flex-col  p-2 border-r border-gray-200 text-600 text-2xl font-bold "
      draggable={false}
    >
